 ...
 */
@Local
public interface TipoCentroFacadeLocal extends AbstractFacadeInterface<TipoCentro>{

//    TipoCentro createTC(TipoCentro tipoCentro);
//    TipoCentro editTC(TipoCentro tipoCentro);
